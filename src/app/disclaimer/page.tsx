...
export const metadata: Metadata = { title: "Disclaimer Affiliate", description: "Disclosure penggunaan link affiliate di website Lalioma." };
      ...
      <div className="section-container">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="glass-card p-6 space-y-5 text-sm text-muted-foreground leading-relaxed">
            <p>Website Lalioma menggunakan link affiliate dari partner booking hotel. Berikut penjelasan lengkapnya:</p>
