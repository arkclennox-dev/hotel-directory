...
import { Pencil, Eye, EyeOff, BookOpen, Search } from "lucide-react";
    ...
    return (
      <div className="rounded-xl border border-gray-800 overflow-hidden">
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <Link href="/admin/blog/form" className="px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-medium rounded-lg transition-colors">
            ...
            <tbody className="divide-y divide-gray-800">
              {filtered.map((post) => (
                <tr key={post.id} className="bg-gray-900 hover:bg-gray-800/50 transition-colors">
                  ...
                  <td className="px-5 py-4">
                    <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium ${post.is_published ? "bg-emerald-500/10 text-emerald-400 border border-emerald-500/20" : "bg-gray-700 text-gray-400 border border-gray-600"}`}>
